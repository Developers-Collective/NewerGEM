...
regular_ts1 = %w(setsugen suichu daishizen)
regular_ts1 += %w(nohara2 koopa_out shiro_koopa gake_yougan)
...
nohara_clones = %w(nohara cracks springwater space chika2 shiro shiro_yogan)
...
g.section('Pa2_gake', 'Pa2_doukutu7') do
...
File.open('E:/NSMBW-Hacking/Puzzle-Next-master/B1s Improved NSMBW Tilesets/Other Stuff/RandTiles.bin', 'wb') do |f|
	f.write g.pack
end
